    ...
    (let ((the-ops
      ...
      (define (dispatch message)
        (cond
          ...
          (else (error "Unknown request -- MACHINE" messagexs))))
      dispatch)))
...
(define (make-execution-procedure inst labels machine pc flag stack ops)
  (cond
    ...
    (else (error "Uknown instruction type -- ASSEMBLE" inst))))
...
(define (make-primitive-exp exp machine labels)
  (cond
    ...
    (else
      (error "Uknown expression type -- ASSEMBLE" exp))))
